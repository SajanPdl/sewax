...
import { Search, AlertTriangle, RefreshCw, Loader2, ArrowUp, ArrowDown } from 'lucide-react';
                   ...
                   <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-right">
                         <div className="flex justify-end gap-1">
                            <button className="p-1 hover:bg-gray-200 rounded text-gray-500" title="Add Stock"><ArrowUp className="w-4 h-4"/></button>
                            <button className="p-1 hover:bg-gray-200 rounded text-gray-500" title="Remove Stock"><ArrowDown className="w-4 h-4"/></button>
                         </div>
                      </td>
                   </tr>
                ))}
